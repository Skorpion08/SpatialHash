...
/**
 * GetInstance the original set of SDL memory functions
 *
...
/**
 * GetInstance the current set of SDL memory functions
 *
...
/**
 * GetInstance the number of outstanding (unfreed) allocations
 *
 * \since This function is available since SDL 2.0.7.
 */
