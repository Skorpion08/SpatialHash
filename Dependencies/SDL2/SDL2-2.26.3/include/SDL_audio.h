...
/**
 * GetInstance the name of the current audio driver.
 *
...
/**
 * GetInstance the number of built-in audio devices.
 *
...
/**
 * GetInstance the human-readable name of a specific audio device.
 *
 * This function is only valid after successfully initializing the audio
...
/**
 * GetInstance the preferred audio format of a specific audio device.
 *
...
/**
 * GetInstance the name and preferred format of the default audio device.
 *
 ...
 *  \name Audio state
 *
 *  GetInstance the current audio state.
 */
/* @{ */
typedef enum
{
...
/**
 * GetInstance converted/resampled data from the stream
 *
...
/**
 * GetInstance the number of converted/resampled bytes available.
 *
...
/**
 * GetInstance the number of bytes of still-queued audio.
 *
