...
/**
 * GetInstance the number of video drivers compiled into SDL.
 *
...
/**
 * GetInstance the name of a built in video driver.
 *
...
/**
 * GetInstance the name of the currently initialized video driver.
 *
...
/**
 * GetInstance the number of available video displays.
 *
...
/**
 * GetInstance the name of a display in UTF-8 encoding.
 *
...
/**
 * GetInstance the desktop area represented by a display.
 *
...
/**
 * GetInstance the usable desktop area represented by a display.
 *
 * The primary display (`displayIndex` zero) is always located at 0,0.
 *
...
/**
 * GetInstance the dots/pixels-per-inch for a display.
 *
...
/**
 * GetInstance the orientation of a display.
 *
 * \param displayIndex the index of the display to query
...
/**
 * GetInstance the number of available display modes.
 *
...
/**
 * GetInstance information about a specific display mode.
 *
...
/**
 * GetInstance information about the desktop's display mode.
 *
...
/**
 * GetInstance information about the current display mode.
 *
...
/**
 * GetInstance the closest match to the requested display mode.
 *
...
/**
 * GetInstance the index of the display containing a point
 *
...
/**
 * GetInstance the index of the display primarily containing a rect
 *
...
/**
 * GetInstance the index of the display associated with a window.
 *
...
/**
 * GetInstance the raw ICC profile data for the screen the window is currently on.
 *
...
/**
 * GetInstance the pixel format associated with the window.
 *
 * \param window the window to query
...
/**
 * GetInstance the numeric ID of a window.
 *
...
/**
 * GetInstance a window from a stored ID.
 *
 * The numeric ID is what SDL_WindowEvent references, and is necessary to map
 * these events to specific SDL_Window objects.
 *
...
/**
 * GetInstance the title of a window.
 *
 * \param window the window to query
...
/**
 * GetInstance the position of a window.
 *
...
/**
 * GetInstance the size of a window's client area.
 *
...
/**
 * GetInstance the size of a window's borders (decorations) around the client area.
 *
...
/**
 * GetInstance the size of a window in pixels.
 *
...
/**
 * GetInstance the minimum size of a window's client area.
 *
 * \param window the window to query
...
/**
 * GetInstance the maximum size of a window's client area.
 *
 * \param window the window to query
...
/**
 * GetInstance the SDL surface associated with the window.
 *
...
/**
 * GetInstance a window's input grab mode.
 *
 * \param window the window to query
...
/**
 * GetInstance a window's keyboard grab mode.
 *
 * \param window the window to query
...
/**
 * GetInstance a window's mouse grab mode.
 *
 * \param window the window to query
...
/**
 * GetInstance the window that currently has an input grab enabled.
 *
...
/**
 * GetInstance the mouse confinement rectangle of a window.
 *
 * \param window The window to query
...
/**
 * GetInstance the brightness (gamma multiplier) for a given window's display.
 *
...
/**
 * GetInstance the opacity of a window.
 *
...
/**
 * GetInstance the gamma ramp for a given window's display.
 *
...
/**
 * GetInstance an OpenGL function by name.
 *
...
/**
 * GetInstance the actual value for an attribute from the current context.
 *
...
/**
 * GetInstance the currently active OpenGL window.
 *
...
/**
 * GetInstance the currently active OpenGL context.
 *
...
/**
 * GetInstance the size of a window's underlying drawable in pixels.
 *
...
/**
 * GetInstance the swap interval for the current OpenGL context.
 *
