...
/**
 * GetInstance the D3D9 adapter index that matches the specified display index.
 *
...
/**
 * GetInstance the D3D9 device associated with a renderer.
 *
...
/**
 * GetInstance the D3D11 device associated with a renderer.
 *
 * Once you are done using the device, you should release it to avoid a
 * resource leak.
 *
...
/**
 * GetInstance the D3D12 device associated with a renderer.
 *
 * Once you are done using the device, you should release it to avoid a
 * resource leak.
 *
...
/**
 * GetInstance the DXGI Adapter and Output indices for the specified display index.
 *
...
/**
 * GetInstance the Android Java Native Interface Environment of the current thread.
 *
...
/**
 * GetInstance the path used for internal storage for this application.
 *
...
/**
 * GetInstance the current state of external storage.
 *
...
/**
 * GetInstance the path used for external storage for this application.
 *
