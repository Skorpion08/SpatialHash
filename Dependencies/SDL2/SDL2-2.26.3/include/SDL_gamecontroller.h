...
/**
 *  GetInstance the SDL joystick layer binding for this controller button/axis mapping
 */
...
/**
 * GetInstance the number of mappings installed.
 *
...
/**
 * GetInstance the mapping at a particular index.
 *
...
/**
 * GetInstance the game controller mapping string for a given GUID.
 *
...
/**
 * GetInstance the current mapping of a Game Controller.
 *
 * The returned string must be freed with SDL_free().
 *
...
/**
 * GetInstance the implementation dependent name for the game controller.
 *
...
/**
 * GetInstance the implementation dependent path for the game controller.
 *
 * This function can be called before any controllers are opened.
 *
 * `joystick_index` is the same as the `device_index` passed to
...
/**
 * GetInstance the type of a game controller.
 *
...
/**
 * GetInstance the mapping of a game controller.
 *
 * This can be called before any controllers are opened.
 *
 * \param joystick_index the device_index of a device, from zero to
...
/**
 * GetInstance the SDL_GameController associated with an instance id.
 *
...
/**
 * GetInstance the SDL_GameController associated with a player index.
 *
...
/**
 * GetInstance the implementation-dependent name for an opened game controller.
 *
...
/**
 * GetInstance the implementation-dependent path for an opened game controller.
 *
...
/**
 * GetInstance the type of this currently opened controller
 *
...
/**
 * GetInstance the player index of an opened game controller.
 *
...
/**
 * GetInstance the USB vendor ID of an opened controller, if available.
 *
...
/**
 * GetInstance the USB product ID of an opened controller, if available.
 *
...
/**
 * GetInstance the product version of an opened controller, if available.
 *
...
/**
 * GetInstance the firmware version of an opened controller, if available.
 *
...
/**
 * GetInstance the serial number of an opened controller, if available.
 *
...
/**
 * GetInstance the Joystick ID from a Game Controller.
 *
...
/**
 * GetInstance the SDL joystick layer binding for a controller axis mapping.
 *
...
/**
 * GetInstance the current state of an axis control on a game controller.
 *
...
/**
 * GetInstance the SDL joystick layer binding for a controller button mapping.
 *
 * \param gamecontroller a game controller
...
/**
 * GetInstance the current state of a button on a game controller.
 *
 * \param gamecontroller a game controller
...
/**
 * GetInstance the number of touchpads on a game controller.
 *
 * \since This function is available since SDL 2.0.14.
 */
...
/**
 * GetInstance the number of supported simultaneous fingers on a touchpad on a game
 * controller.
 *
 * \since This function is available since SDL 2.0.14.
 */
...
/**
 * GetInstance the current state of a finger on a touchpad on a game controller.
 *
 * \since This function is available since SDL 2.0.14.
 */
...
/**
 * GetInstance the data rate (number of events per second) of a game controller
 * sensor.
 *
 * \param gamecontroller The controller to query
 * \param type The type of sensor to query
...
/**
 * GetInstance the current state of a game controller sensor.
 *
...
/**
 * GetInstance the current state of a game controller sensor with the timestamp of the
 * last update.
 *
 * The number of values and interpretation of the data is sensor dependent.
 * See SDL_sensor.h for the details for each type of sensor.
