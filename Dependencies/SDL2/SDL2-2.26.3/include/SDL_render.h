...
/**
 * GetInstance the number of 2D rendering drivers available for the current display.
 *
...
/**
 * GetInstance info about a specific 2D rendering driver for the current display.
 *
...
/**
 * GetInstance the renderer associated with a window.
 *
...
/**
 * GetInstance the window associated with a renderer.
 *
...
/**
 * GetInstance information about a rendering context.
 *
...
/**
 * GetInstance the output size in pixels of a rendering context.
 *
...
/**
 * GetInstance the additional color value multiplied into render copy operations.
 *
 * \param texture the texture to query
...
/**
 * GetInstance the additional alpha value multiplied into render copy operations.
 *
 * \param texture the texture to query
...
/**
 * GetInstance the blend mode used for texture copy operations.
 *
 * \param texture the texture to query
...
/**
 * GetInstance the scale mode used for texture scale operations.
 *
 * \param texture the texture to query.
...
/**
 * GetInstance the user-specified pointer associated with a texture
 *
 * \param texture the texture to query.
...
/**
 * GetInstance the current render target.
 *
 * The default render target is the window for which the renderer was created,
...
/**
 * GetInstance device independent resolution for rendering.
 *
...
/**
 * GetInstance whether integer scales are forced for resolution-independent rendering.
 *
...
/**
 * GetInstance the drawing area for the current target.
 *
 * \param renderer the rendering context
...
/**
 * GetInstance the clip rectangle for the current target.
 *
...
/**
 * GetInstance whether clipping is enabled on the given renderer.
 *
...
/**
 * GetInstance the drawing scale for the current target.
 *
...
/**
 * GetInstance logical coordinates of point in renderer when given real coordinates of
 * point in window.
 *
...
/**
 * GetInstance real coordinates of point in window when given logical coordinates of
 * point in renderer.
 *
 * Logical coordinates will differ from real coordinates when render is scaled
 * and logical renderer size set
...
/**
 * GetInstance the color used for drawing operations (Rect, Line and Clear).
 *
 * \param renderer the rendering context
...
/**
 * GetInstance the blend mode used for drawing operations.
 *
 * \param renderer the rendering context
 * \param blendMode a pointer filled in with the current SDL_BlendMode
 * \returns 0 on success or a negative error code on failure; call
...
/**
 * GetInstance the CAMetalLayer associated with the given Metal renderer.
 *
...
/**
 * GetInstance the Metal command encoder for the current frame
 *
 * This function returns `void *`, so SDL doesn't have to include Metal's
