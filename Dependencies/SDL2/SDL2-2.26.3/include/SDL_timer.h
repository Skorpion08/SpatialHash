...
/**
 * GetInstance the number of milliseconds since SDL library initialization.
 *
...
/**
 * GetInstance the current value of the high resolution counter.
 *
...
/**
 * GetInstance the count per second of the high resolution counter.
 *
